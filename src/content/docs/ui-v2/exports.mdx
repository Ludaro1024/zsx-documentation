...
<Aside> for returning Values there are no Example Codes because they are just functions that return values</Aside>

<Tabs>
<TabItem label = "Get Color">
...
<TabItem label ="Get Options">
<Tabs>
<TabItem label = "Default HUD">
<Code code={`xports['ZSX_UIV2']:GetHudOptions()`} lang="lua"> </Code>
</TabItem>
<TabItem label = "Car HUD">
...
<Code code={`exports['ZSX_UIV2']:OpenCinematic()`} lang="lua"> </Code>
</TabItem>
</Tabs>
</TabItem>
</Tabs>
