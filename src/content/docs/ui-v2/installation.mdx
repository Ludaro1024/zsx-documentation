...
The UI resource includes an auto-installer for the UI into `ox_lib` and Frameworks. This feature is still in development and you can use it by using these commands:
/install_ox_lib_compatibility
and
/install_qb_core_compatibility

to install the UI into the respective scripts so that it works when using their functions.
